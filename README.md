...
This is my VM for playing CTFs on Windows.
The VM is provisioned by Vagrant with Hyper-V, VirtualBox, or VMware as the hypervisor.
...
After you setup a hypervisor<sup>1</sup> and install Vagrant<sup>2</sup>, you can run the VM in an Administrator command prompt with just
...
### Notes
<sup>1</sup> For Windows users, here is Microsoft's guide to "[install Hyper-V](https://docs.microsoft.com/en-us/virtualization/hyper-v-on-windows/quick-start/enable-hyper-v)."  
<sup>2</sup>
